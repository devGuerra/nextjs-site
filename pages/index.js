...
import GroupByApp from '../Components/GroupByApp'
...
export default function Home({ groups, categories }) {
  ...
  useEffect(() => setGroupParams(router.query), [router.query])
  return (
    <>
      <Head>
        ...
        encontre as melhores categorias, gratis e facil, em apenas um click ja esta com um novo Grupo do whatsapp"></meta>
      ...
      <main>
        {groupParams.avatar ? (
          <div className="feedOne">
            <div className="group">
              <GroupByApp data={{
                avatar: groupParams.avatar + "&oh=" + groupParams.oh,
                url: groupParams.url,
